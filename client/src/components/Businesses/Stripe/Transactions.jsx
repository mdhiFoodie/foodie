...
class Transactions extends Component {
    ...
    try {
      ...
      if (token) {
        ...
        const data = await axios.post(
          'http://localhost:3000/api/stripe/createAccount',
          body
        );
        this.setState({
          finishInfo: true,
  ...
  createCardToken = async e => {
    ...
    try {
      ...
      const data = await axios.post(
        'http://localhost:3000/api/stripe/createCustomerId',
        body
      );
      if (data) {
      ...
      console.log(
        'Error from create card token on Transactions component -',
        err
      );
    }
  };
        ...
        {!this.state.finishInfo ? (
          <div className="paymentContainer">
            <form className="my-form" onSubmit={this.createToken}>
              ...
              <div className="terms">
                By clicking, you agree to <a href="#">our terms</a> and the{' '}
